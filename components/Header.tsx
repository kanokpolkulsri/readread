      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center cursor-pointer group" onClick={onHomeClick}>
            ...
            <span className="font-serif text-2xl font-bold text-slate-800 tracking-tight">Novellis</span>
          </div>

          {/* Desktop Nav */}
          <nav className="hidden md:flex space-x-8">
            <button onClick={onHomeClick} className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">Bookstore</button>
            <button className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">My Shelf</button>
            <button className="text-slate-600 hover:text-indigo-600 font-medium transition-colors">Insights</button>
          </nav>
